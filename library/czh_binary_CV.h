...
void
czh_HoughLinesStandard(const Mat& img, float rho, float theta, int threshold, std::vector<Vec2f>& lines, int linesMax = 0, double min_theta = 0,
	double max_theta = CV_PI);	// 此函数是OpenCV里的标准霍夫线变换，并非本人所编写，放置于此便于学习与查找
